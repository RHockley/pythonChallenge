This repository contains files for Module 3 (Python) Homework Project for UWA Data Analytics Bootcamp.

This project included 2 different data sets requiring 2 different sets of code. The final result was a printout in the terminal and emporting the analysis to a .txt file in a different folder to the original data.

Some of the questions were a challenge and I didn't finish everything to the required standard, but I am starting to understand the nuances of Python and am able to see the power behind it.
